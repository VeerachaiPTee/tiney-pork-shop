...
class Product {
  ...
  static insertProduct(
    ...
    const query = `INSERT INTO PRODUCT (NAME, DETAIL, PRICE, TOTAL, FILELINK, FILENAME, PROMOTION, PROMOTION_PRICE) VALUES ('${NAME}','${DETAIL}',${PRICE}, ${TOTAL}, '${FILELINK}', '${FILENAME}', ${PROMOTION}, ${PROMOTION_PRICE})`
    return sqlcmd(query)
  }
  ...
  static updateProduct(
    ...
    if (
      ...
      query = `UPDATE PRODUCT SET NAME = '${NAME}', DETAIL = '${DETAIL}', PRICE = ${PRICE}, TOTAL = ${TOTAL}, PROMOTION = ${PROMOTION}, PROMOTION_PRICE = ${PROMOTION_PRICE} WHERE ID = ${ID}`
    } else {
